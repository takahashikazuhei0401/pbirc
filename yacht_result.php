<?php
    ...
    $nagasa = htmlspecialchars($_POST['nagasa'], ENT_QUOTES);
...
// ＰＢ責任保険金額保険料
    $array_sekinin_8ika = ["10200","10700","11100","11400","11800","12000","12100","12300","12500","12700","12900","13100","13200"];
    $array_sekinin_8goe_5ton_ika = ["14700","15700","16300","16800","17500","17900","18200","18600","18900","19200","19500","19800","20100"];
    $array_sekinin_8goe_5ton_ijou = ["error","17200","17980","19680","22400","24330","25960","27280","28830","30300","31620","32780","33940"];
...
// ＰＢ責任保険料算出
    if ($nagasa_kubun == 1 && $tonsu_kubun == 1) {
        $hokenryo_sekinin = $array_sekinin_8ika[$kingaku_sekinin -1];
    } else if ($nagasa_kubun == 2 && $tonsu_kubun == 1) {
        $hokenryo_sekinin = $array_sekinin_8goe_5ton_ika[$kingaku_sekinin -1];
    } else if ($nagasa_kubun == 2 && $tonsu_kubun == 2) {
       
            $hokenryo_sekinin = $array_sekinin_8goe_5ton_ijou[$kingaku_sekinin -1];
...
<header>
    <div class="container">
        <h1><a href="index.html">プレジャーヨット保険料</a></h1>
    </div>
</header>
<main>
    <div class="container">
...
//                            if($select_toujousha !== "not_toujousha" || $select_ryokyaku !== "not_joukyaku") {
        ...
        <a class="btn3" href="yacht.php">戻る</a>
