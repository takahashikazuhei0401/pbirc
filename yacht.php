...
<main>
    <div class="container">
            <form method="post" name="form1" action="yacht_result.php">
                <div class="sentaku hune">

                    <h2>---船の情報を入力して下さい---</h2>
                    <h3>船の種類</h3>
                    <p>プレジャーヨット</p>
                    <h3 id="test2">船舶の長さ</h3>
                    <input id="nagasa" type="number" step="0.01" name="nagasa" min="0.01" max="99" required>
                    <h3>総トン数</h3>
        ...
        <div class="reset">
            ...
            <a class="btn3" href="yacht.php">リセット</a>
        </div>
    </div>
</main>    
<footer>
 ...
 // 変数の定義
        var nagasa = document.getElementById('nagasa');  
